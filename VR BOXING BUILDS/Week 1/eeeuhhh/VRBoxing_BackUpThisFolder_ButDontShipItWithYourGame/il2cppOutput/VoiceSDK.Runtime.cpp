...
IL_0031:
	{
		...
		NullCheck(L_6);
		WitConfiguration_t3D1E7D46065A2742877307705778E1CBC33530DD* L_7 = L_6->___witConfiguration_0;
		NullCheck(L_7);
		String_t* L_8;
		L_8 = WitConfiguration_get_WitApplicationId_m6634CD56C438E238FC8619A3AF08F33733D0F0B1(L_7, NULL);
		NullCheck(L_5);
		InterfaceActionInvoker1< String_t* >::Invoke(5 /* System.Void Oculus.Voice.Core.Bindings.Interfaces.IVoiceSDKLogger::set_WitApplication(System.String) */, IVoiceSDKLogger_t8A0710A01D6E9FAA8D2FFE4190C3BD848CA655C0_il2cpp_TypeInfo_var, L_5, L_8);
		// voiceSDKLoggerImpl.ShouldLogToConsole = EnableConsoleLogging;
		RuntimeObject* L_9 = __this->___voiceSDKLoggerImpl_13;
		bool L_10;
		L_10 = AppVoiceExperience_get_EnableConsoleLogging_mA4FAB753C46C4F0D7291C255D8F5C4E3152EC151_inline(__this, NULL);
		NullCheck(L_9);
		InterfaceActionInvoker1< bool >::Invoke(3 /* System.Void Oculus.Voice.Core.Bindings.Interfaces.IVoiceSDKLogger::set_ShouldLogToConsole(System.Boolean) */, IVoiceSDKLogger_t8A0710A01D6E9FAA8D2FFE4190C3BD848CA655C0_il2cpp_TypeInfo_var, L_9, L_10);
		// OnInitialized?.Invoke();
		Action_tD00B0A84D7945E50C2DFFC28EFEE6ED44ED2AD07* L_11 = __this->___OnInitialized_14;
